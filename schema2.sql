...
--
-- Host: localhost
-- Generation Time: May 11, 2011 at 12:18 PM
...
CREATE TABLE IF NOT EXISTS `images` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `category` varchar(22) COLLATE utf8_bin DEFAULT NULL COMMENT 'Primary, Landscape, Other-TBD',
  `orientation` varchar(5) CHARACTER SET utf8 DEFAULT NULL,
  `season` varchar(20) CHARACTER SET utf8 DEFAULT NULL,
  `in-flower` varchar(11) COLLATE utf8_bin DEFAULT NULL COMMENT 'Image showing flowers',
