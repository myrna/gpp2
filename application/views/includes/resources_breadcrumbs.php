<div id="breadcrumbs">
      ...
      echo " id=\"current\""; ?> href="<?php echo base_url();?>nurserylist/">Nursery Directory</a>  &raquo;
     <a <?php if ($this->uri->segment(2)=="links")
      echo " id=\"current\""; ?> href="<?php echo base_url();?>resources/links/">Helpful Links</a>  &raquo;
     <a <?php if ($this->uri->segment(2)=="glossary")
      echo " id=\"current\""; ?> href="<?php echo base_url();?>resources/glossary/">Glossary</a>
</div><!-- end breadcrumbs -->